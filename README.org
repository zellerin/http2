...
Priorities are not implemented. Push promises are not implemented, but they are disabled by default. Dynamic table is not used for encoding and decoding headers.
